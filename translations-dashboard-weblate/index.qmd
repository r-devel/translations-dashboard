...
# Weblate {orientation="rows" scrolling="true"}
...
```{r translated messages valuebox}
#| content: valuebox
#| title: "Translated Messages"
#| icon: chat
#| color: success
list(
  value = sum(Language_Statistics_new$Translated)
)
```

```{r untranslated messages valuebox}
#| content: valuebox
#| title: "Untranslated Messages"
#| icon: chat-slash
#| color: warning
list(
  value = sum(Language_Statistics_new$Untranslated)
)
```

```{r fuzzy messages valuebox}
#| content: valuebox
#| title: "Fuzzy Messages"
#| icon: puzzle
#| color: info
list(
  value = sum(Language_Statistics_new$Fuzzy)
)
```
::::
...
```{r}
#| title: "Graph of Top 10 Users vs Translation"
...
### Translations {orientation="rows" scrolling="true"}
