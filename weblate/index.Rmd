...
```{r}
# Exclude new translations that are currently marked for edit
# since they remain untranslated from user point of view
exclude <- which(New_Translation$units %in% Marked_for_Edit$id)
New_Translation<-New_Translation[-exclude,]
