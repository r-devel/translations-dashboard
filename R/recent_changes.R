...
library(stringr)
library(readr)
Language_Statistics <- read_csv("./data/language_statistics.csv")
...
write_csv(translated_data,"data/new_translation.csv")
write_csv(mark_data,"data/marked_for_edit.csv")
